...
class signUp(QMainWindow):
    def __init__(self):
        ...
        self.loginStack.addWidget(self.name)
        self.loginStack.addStretch()
        ...
        self.detailsStack.addWidget(self.company)
        self.detailsStack.addStretch()
    ...
    def newUser(self):
        ...
        if name and email and password and confirm and company and department and discipline:
            if password == confirm:
                addUser(name, department, discipline, email, password, company)
                self.name.clear()
                self.email.clear()
                self.password.clear()
                self.confirm.clear()
