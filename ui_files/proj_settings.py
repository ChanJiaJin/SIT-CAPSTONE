...
class Settings(QWidget):
    def __init__(self, abbv):
        ...
        self.addTask.clicked.connect(self.newTask(abbv))
        ...
        self.ganttTable.setColumnCount(3)
        ...
        self.update.clicked.connect(self.update(abbv))
        ...
        memebrsPalette.setBrush(
            QPalette.Disabled, QPalette.Window, membersBrush)
